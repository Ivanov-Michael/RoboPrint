 ...
 * 
 * 09.10.20
 * Последняя рабочая версия (чистая) Марлина. Печать и кинематика работают (редактировали с Владом).
 * 
 *
 */
...
#define CUSTOM_MACHINE_NAME "RoboPrint"
 ...
 *                                           A       B       C       D
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { (200*16)/(16.0*20), (200*16)/(16.0*20), (200*16)/(16.0*20), (200*16)/(16.0*20), DEFAULT_E_AXIS_STEPS_PER_UNIT }
 
//#define DEFAULT_AXIS_STEPS_PER_UNIT   { (200*16)/(2.0*20), (200*16)/(2.0*20), (200*16)/(2.0*20), (200*16)/(2.0*20), DEFAULT_E_AXIS_STEPS_PER_UNIT }
