...
#define HANGPRINTER_IK(V) do {                             \
    float z = V[Z_AXIS]; \
    line_lengths[A_AXIS] = -1.0*(V[X_AXIS] + 650.0 - sqrt(sq(405.0) - sq(115.0 - 49.6 + V[Y_AXIS]) - sq(350.0 - z))); \
    line_lengths[B_AXIS] = 1.0*(-V[X_AXIS] + 650.0 - sqrt(sq(405.0) - sq(115.0 - 49.6 + V[Y_AXIS]) - sq(350.0 - z))); \
    line_lengths[C_AXIS] = 1.0*(-V[X_AXIS] + 650.0 - sqrt(sq(405.0) - sq(115.0 - 49.6 - V[Y_AXIS]) - sq(350.0 - z))); \
    line_lengths[D_AXIS] = 1.0*(V[X_AXIS] + 650.0 - sqrt(sq(405.0) - sq(115.0 - 49.6 - V[Y_AXIS]) - sq(350.0 - z))); \
  }while(0)
